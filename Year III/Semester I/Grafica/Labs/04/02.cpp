...
float xMin = -80.f, xMax = 80.f, yMin = -80.f, yMax = 80.f;
...
void CreateVBO(void)
{
	...
	{
		-10.0f, -10.0f,  0.0f,  1.0f, // bottom right
		-60.0f, -10.0f,  0.0f,  1.0f, // bottom left
		-60.0f, 40.0f,  0.0f,  1.0f, // top right
		-10.0f,  40.0f,  0.0f,  1.0f, // top right
		-35.0f, 60.0f, 0.0f, 1.0f, // roof
	};
	...
	{
		 40.0f, -10.0f,  0.0f,  1.0f, // bottom right
		 30.0f, -10.0f,  0.0f,  1.0f, // bottom left
		 30.0f, 30.0f,  0.0f,  1.0f, // top right
		 40.0f,  30.0f,  0.0f,  1.0f, // top right
		 15.0f, 30.0f, 0.0f, 1.0f,
		 55.0f, 30.0f, 0.0f, 1.0f,
		 35.0f, 60.0f, 0.0f, 1.0f,
	};
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Lab 04 - Ex 02");		//	Creeaza fereastra de vizualizare, indicand numele acesteia;
