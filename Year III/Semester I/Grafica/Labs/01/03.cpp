...
void CreateVBO(void)
{
    ...
    GLfloat Vertices[] = {
         -0.5f, -0.5f, 0.0f, 1.0f,  // Green
         0.1f,  -0.5f, 0.0f, 1.0f, // Yellow
         0.1f, 0.3f, 0.0f, 1.0f,   // White
         -0.5f, 0.3f, 0.0f, 1.0f,   // Cyan
         -0.3, 0.5f, 0.0f, 1.0f,    // Blue
         0.3f, 0.5f, 0.0f, 1.0f,    // Magenta
         0.1f, 0.3f, 0.0f, 1.0f,   // White
         0.1f,  -0.5f, 0.0f, 1.0f, // Yellow
         0.3f, -0.3f, 0.0f, 1.0f,   // Red
    };
    ...
    //  Se creeaza / se leaga un VAO (Vertex Array Ob   ject) - util cand se utilizeaza mai multe VBO;
...
void RenderFunction(void)
{
    ...
    glDrawArrays(GL_QUADS, 0, 4);  // De explorat si alte variante de primitive
...
int main(int argc, char* argv[])
{
    ...
    glutCreateWindow("Lab 01 - Ex 03");   //	 Creeaza fereastra de vizualizare, indicand numele acesteia;
