...
void RenderFunction(void)
{
    ...
    glPointSize(25.0f);                  //  Se seteaza dimensiunea punctelor;
    glLineWidth(50.0f);
...
int main(int argc, char* argv[])
{
    ...
    glutCreateWindow("Lab 01 - Ex 04");   //  Creeaza fereastra de vizualizare, indicand numele acesteia;
